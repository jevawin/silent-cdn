...
const getFormData = () => {
  ...
  try {
    ...
    formData.appointmentKind = document.querySelector("input[name='appointment-kind']:checked").value;
    formData.appointmentDetails = document.querySelector("textarea[name='Appointment-details']").value;
    formData.duration = `${document.querySelector("select[name='Duration-Hours']").value}h${document.querySelector("select[name='Duration-Minutes']").value}m`;
    ...
    formData.bookingFor = `${document.querySelector("input[name='First-Name']").value} ${document.querySelector("input[name='Last-Name']").value}`;
